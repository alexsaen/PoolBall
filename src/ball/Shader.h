...
public: 
	...
	static	void	unuse();
			...
			void	uniform(const char *uid, const vec3 &value);
			void	uniform(const char *uid, const vec4 &value);
			void	uniform(const char *uid, const mat4 &value);
			void	uniform(const char *uid, const mat3 &value);

			void	uniform(STD_UNIFORM id, int value);
			void	uniform(STD_UNIFORM id, float value);
			void	uniform(STD_UNIFORM id, const vec2 &value);
			void	uniform(STD_UNIFORM id, const vec3 &value);
			void	uniform(STD_UNIFORM id, const vec4 &value);
			void	uniform(STD_UNIFORM id, const mat4 &value);
			void	uniform(STD_UNIFORM id, const mat3 &value);
